...
def my_sum():
    ...
    if numerator1[1] != numerator2[1]:     # Если знаменатели не равны
        numerator = int(numerator1[0]) * int(numerator2[1]) + int(numerator2[0]) * int(numerator1[1])
        denumerator = int(numerator1[1]) * int(numerator2[1])
    ...
    if numerator == denumerator:
        ...
        print(f"Сумма = {numerator}")
    else:
        print(f"Сумма = {int(numerator)}/{int(denumerator)}")
